...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get tourSubconsciousTitle => 'المهام — مساحة القناعات';

  @override
  String get tourSubconsciousBody =>
      'افتح المهام، ثم لسان «القناعات» للمهام الذهنية: يوميات، صوت موجّه، تأكيدات، واللعبة الداخلية. التسجيل هنا يحافظ على سلسلة أيامك وانضباطك.';
  ...
  String get tourDealRoomBody =>
      'تحت «التركيز»، زر العملاء يبدّل بين غرفة الصفقات (خط الأنابيب والإجراءات) وتتبع الإيرادات. غرفة الصفقات هي مكان المتابعة والزخم مع العملاء.';
