            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Icon(Icons.vibration_rounded, size: 70, color: Color(0xFF667eea))
                      .animate()
                  ...
                  Row(
                    ...
                    children: [
                      const Text("Didn't receive a code?", style: TextStyle(color: Color(0xFF64748B))),
                      TextButton(
                        onPressed: () => Navigator.pop(context),
                        child: const Text('Resend', style: TextStyle(color: Color(0xFF667eea), fontWeight: FontWeight.bold)),
                      ),
                    ],
                  ),
                ],
